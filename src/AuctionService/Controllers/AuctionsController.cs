...
[ApiController]
[Route("api/auctions")]
public class AuctionsController(AuctionDbContext _context, IMapper _mapper, 
                                IPublishEndpoint _publishEndPoint): ControllerBase
{
    ...
    {
        var auction = await _context.Auctions.Include(x => x.Item ).FirstOrDefaultAsync(auction=> auction.Id == id);
